 ...
 *
 */
class DiaFileFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'linename' => ['type' => 'string', 'length' => 255, 'null' => false, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
    ...
    public $records = [
        [
            ...
            'linename' => 'test line',
            'status' => 1,
            'created' => '2018-03-03 01:57:37',
            'updated' => '2018-03-03 01:57:37'
        ],
    ];
}
